...
var $         = require('jquery'),
    ...
    configMap = {
      ...
      '                </div>' +
      '                <div class="col-xs-2">' +
      '                    <input type="date" class="form-control" placeholder="请输入日期" id="spa-editor-date" />' +
      '                </div>' +
      '                <div class="col-xs-2">' +
      '                    <div class="checkbox">' +
      '                        <label>' +
...
updatePostData = function ()
{
  ...
  stateMap.post.date  = jqueryMap.$date.val();
...
setJqueryMap = function ()
{
  ...
  jqueryMap      = {
    ...
    $date: $container.find('#spa-editor-date'),
