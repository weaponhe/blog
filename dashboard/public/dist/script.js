...
},{"./spa.model":3,"./spa.shell":4,"jquery":15}],3:[function(require,module,exports){
var $ = require('jquery'),
...
},{"./spa.event":1,"datekit":13,"jquery":15}],4:[function(require,module,exports){
var $ = require('jquery'),
    Model = require('./spa.model'),
...
},{"./spa.model":3,"./spa.widget.editor":6,"./spa.widget.modal":9,"./spa.widget.modal.book":7,"./spa.widget.modal.demo":8,"./spa.widget.modal.project":10,"./spa.widget.nav":11,"./spa.widget.table":12,"jquery":15}],5:[function(require,module,exports){
var setConfigMap;
...
},{"./spa.event":1,"./spa.util":5,"jquery":15}],7:[function(require,module,exports){
module.exports = {
	body_html: String() +
		'    <div class="input-group">' +
		'        <span class="input-group-addon">书  名</span>' +
		'        <input id="spa-modal-books-title" type="text" class="form-control" aria-describedby="basic-addon1">' +
		'    </div>' +
		'    <div class="input-group">' +
		'        <span class="input-group-addon">作  者</span>' +
		'        <input id="spa-modal-books-author" type="text" class="form-control" aria-describedby="basic-addon1">' +
		'    </div>' +
		'    <div class="input-group">' +
		'        <span class="input-group-addon">出  版</span>' +
		'        <input id="spa-modal-books-publisher" type="text" class="form-control" aria-describedby="basic-addon1">' +
		'    </div>' +
		'    <div class="input-group">' +
		'        <span class="input-group-addon">链   接</span>' +
		'        <input id="spa-modal-books-link" type="text" class="form-control" aria-describedby="basic-addon1">' +
		'    </div>' +
		'    <div class="input-group">' +
		'        <span class="input-group-addon">图   片</span>' +
		'        <input id="spa-modal-books-img" type="text" class="form-control" aria-describedby="basic-addon1">' +
		'    </div>' +
		'    <select id="spa-modal-books-status" class="form-control">' +
		'        <option>想读</option>' +
		'        <option>在读</option>' +
		'        <option>已读</option>' +
		'    </select>'
...
module.exports = {
    ...
    '        <input id="spa-modal-demos-title" type="text" class="form-control" aria-describedby="basic-addon1">' +
    '    </div>' +
    '    <div class="input-group">' +
    '        <span class="input-group-addon">链 接</span>' +
    '        <input id="spa-modal-demos-link" type="text" class="form-control" aria-describedby="basic-addon1">' +
    '    </div>' +
    '    <div class="input-group">' +
    '        <span class="input-group-addon">标 签</span>' +
    '        <input id="spa-modal-demos-tag" type="text" class="form-control" aria-describedby="basic-addon1">' +
    '    </div>' +
    '    <div class="input-group">' +
    '        <span class="input-group-addon">简 介</span>' +
    '        <input id="spa-modal-demos-intro" type="text" class="form-control" aria-describedby="basic-addon1">' +
    '    </div>'
};
...
},{"./spa.event":1,"./spa.util":5,"jquery":15}],10:[function(require,module,exports){
module.exports = {
    body_html: String() +
    '    <div class="input-group">' +
    '        <span class="input-group-addon">标 题</span>' +
    '        <input id="spa-modal-projects-title" type="text" class="form-control" aria-describedby="basic-addon1">' +
    '    </div>' +
    '    <div class="input-group">' +
    '        <span class="input-group-addon">链 接</span>' +
    '        <input id="spa-modal-projects-link" type="text" class="form-control" aria-describedby="basic-addon1">' +
    '    </div>' +
    '    <div class="input-group">' +
    '        <span class="input-group-addon">标 签</span>' +
    '        <input id="spa-modal-projects-tag" type="text" class="form-control" aria-describedby="basic-addon1">' +
    '    </div>' +
    '    <div class="input-group">' +
    '        <span class="input-group-addon">简 介</span>' +
    '        <input id="spa-modal-projects-intro" type="text" class="form-control" aria-describedby="basic-addon1">' +
    '    </div>'
};
...
},{"./spa.event":1,"./spa.util":5,"jquery":15}],12:[function(require,module,exports){
//---------------- BEGIN MODULE SCOPE VARIABLES --------------
var $ = require('jquery'),
	Util = require('./spa.util'),
	Event = require('./spa.event');
...
},{"./spa.event":1,"./spa.util":5,"jquery":15}],13:[function(require,module,exports){
